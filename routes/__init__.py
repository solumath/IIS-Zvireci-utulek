...
from .routes import about, index, not_enough_perms, page_not_found, profile
...
from .examinations import examinations, examinations_delete, examinations_add, examinations_edit
